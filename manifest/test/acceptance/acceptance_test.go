...
import (
	...
	tftest "github.com/chnsz/terraform-provider-kubernetes/manifest/test/plugintest"

	kuberneteshelper "github.com/chnsz/terraform-provider-kubernetes/manifest/test/helper/kubernetes"
)
