...
import (
	...
	"github.com/chnsz/terraform-provider-kubernetes/manifest"
	"github.com/chnsz/terraform-provider-kubernetes/manifest/morph"
	"github.com/chnsz/terraform-provider-kubernetes/manifest/payload"
)
