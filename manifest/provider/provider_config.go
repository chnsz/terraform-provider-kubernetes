...
import (
	...
	authplugin "github.com/chnsz/terraform-provider-kubernetes/common"
)
...
func GetProviderConfigSchema() *tfprotov5.Schema {
	b := tfprotov5.SchemaBlock{
		...
		Attributes: []*tfprotov5.SchemaAttribute{
			...
			{
				Name:            authplugin.AccessKeyConfiguration,
				Type:            tftypes.String,
				Description:     fmt.Sprintf("Access key for k8s managed in Huawei Cloud CCE. Can be set with %s.", strings.ToUpper(authplugin.AccessKeyConfiguration)),
				Required:        false,
				Optional:        true,
				Computed:        false,
				Sensitive:       false,
			...
			{
				Name:            authplugin.SecretKeyConfiguration,
				Type:            tftypes.String,
				Description:     fmt.Sprintf("Secret key for k8s managed in Huawei Cloud CCE. Can be set with %s.", strings.ToUpper(authplugin.SecretKeyConfiguration)),
				Required:        false,
				Optional:        true,
				Computed:        false,
				Sensitive:       false,
			...
			{
				Name:            authplugin.ProjectIdConfiguration,
				Type:            tftypes.String,
				Description:     fmt.Sprintf("Project which contains k8s cluster instance. Can be set with %s.", strings.ToUpper(authplugin.ProjectIdConfiguration)),
				Required:        false,
				Optional:        true,
				Computed:        false,
				Sensitive:       false,
			...
			{
				Name:            authplugin.SecurityTokenConfiguration,
				Type:            tftypes.String,
				Description:     fmt.Sprintf("Security token for k8s managed in Huawei Cloud CCE. Can be set with %s.", strings.ToUpper(authplugin.SecurityTokenConfiguration)),
				Required:        false,
				Optional:        true,
				Computed:        false,
				Sensitive:       false,
