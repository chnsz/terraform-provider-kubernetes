...
func TestAccKubernetesHorizontalPodAutoscalerV2Beta2_minimal(t *testing.T) {
...
func TestAccKubernetesHorizontalPodAutoscalerV2Beta2_basic(t *testing.T) {
	name := fmt.Sprintf("tf-acc-test-%s", acctest.RandString(10))
	resourceName := "kubernetes_horizontal_pod_autoscaler_v2beta2.test"
...
func testAccKubernetesHorizontalPodAutoscalerV2Beta2Config_minimal(name string) string {
...
func testAccKubernetesHorizontalPodAutoscalerV2Beta2Config_basic(name string) string {
	return fmt.Sprintf(`resource "kubernetes_horizontal_pod_autoscaler_v2beta2" "test" {
  metadata {
    name = %q
...
func testAccKubernetesHorizontalPodAutoscalerV2Beta2Config_modified(name string) string {
	return fmt.Sprintf(`resource "kubernetes_horizontal_pod_autoscaler_v2beta2" "test" {
  metadata {
    name = %q
