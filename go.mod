module github.com/chnsz/terraform-provider-kubernetes
...
require (
	...
	github.com/hashicorp/terraform-provider-kubernetes v0.0.0
...
require (
	...
	k8s.io/kube-aggregator v0.27.8 // indirect
)
...
replace (
	...
	github.com/hashicorp/terraform-provider-kubernetes => github.com/chnsz/hashicorp_terraform-provider-kubernetes v0.0.0-20240104083711-224261a227ad
